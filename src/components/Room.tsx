        ...
        <div className="md:col-span-2">
          {isWaiting && isHost && (
            <div className="bg-white rounded-lg shadow p-4 mb-4">
              ...
              <p className="mb-4">Share this code with your friends: <span className="font-bold">{room.code}</span></p>
          ...
          {isPlaying && player.selectedCard && (
            <div className="bg-white rounded-lg shadow p-4 mb-4">
              <h2 className="text-xl font-bold mb-4">Your Card</h2>
              <LoToCard card={player.selectedCard} playable={true} />
            </div>
          )}
